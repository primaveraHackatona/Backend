package com.primavera.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		.basePackage("com.primavera.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			.title("API - Primavera")
			.description("Projeto API Spring - Primavera")
			.version("1.0.0")
			.license("Apache License Version 2.0")
			.licenseUrl("https://github.com/primaveraHackatona/Backend")
			.contact(contact())
			.build();
	}
